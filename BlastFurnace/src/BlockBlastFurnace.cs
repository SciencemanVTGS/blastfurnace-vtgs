...
{
    public class BlockBlastFurnace : Block, IIgnitable
    {
        ...
        public override void OnLoaded(ICoreAPI api)
        {
            ...
            interactions = ObjectCacheUtil.GetOrCreate(api, "blastFurnaceBlockInteractions", () =>
            {
                ...
                foreach (CollectibleObject obj in api.World.Collectibles)
                {
                    ...
                    {
                        if (obj.CombustibleProps?.BurnTemperature >= 1340)
                        {
                            List<ItemStack> stacks = obj.GetHandBookStacks(capi);
                ...
                return new WorldInteraction[] {
                    new WorldInteraction()
                    {
                        ...
                        {
                            BlockEntityBEBlastFurnace bef = api.World.BlockAccessor.GetBlockEntity(bs.Position) as BlockEntityBEBlastFurnace;
        ...
        {
            BlockEntityBEBlastFurnace bea = byEntity.World.BlockAccessor.GetBlockEntity(pos) as BlockEntityBEBlastFurnace;
        ...
        {
            BlockEntityBEBlastFurnace bea = world.BlockAccessor.GetBlockEntity(blockSel.Position) as BlockEntityBEBlastFurnace;
            if (bea != null)
            {
