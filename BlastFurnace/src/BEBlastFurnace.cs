...
{
    public class BlockEntityBEBlastFurnace : BlockEntity, IHeatSource, ITemperatureSensitive
    {
            ...
            if (burning)
            {
                ...
                if (contents != null)
                {
                    ...
                    if (temp < 3000)
                    {
                        ...
                        contents.Collectible.SetTemperature(Api.World, contents, Math.Min(3000, temp + tempGain));
                    }
                }
            }
        ...
        public void CoolNow(float amountRel)
        {
            ...
            {
                playsound = temp > 100;
                contents.Collectible.SetTemperature(Api.World, contents, Math.Min(3000, temp - amountRel * 20), false);
                MarkDirty(true);
            }
